...
const projects = [
  { id:1,  title:"Battery Mineral Project",     url:"https://batterymineralproject.com/",             category:"Industry",    accent:"#f59e0b", pattern:"grid",  size:"large",  desc:"Mining & resources sector digital presence with investor-focused content architecture." },
  { id:2,  title:"Juris Maximus",               url:"https://www.jurismaximus.com/",                   category:"Legal",       accent:"#6366f1", pattern:"dots",  size:"normal", desc:"Premium law firm website with case management portal and professional brand identity." },
  { id:3,  title:"Walus Bookkeeping",           url:"https://walusbookkeeping.com/",                   category:"Finance",     accent:"#d4af37", pattern:"lines", size:"normal", desc:"Boutique bookkeeping firm digital presence with service showcasing and client intake." },
  { id:4,  title:"Ask CSS",                     url:"https://www.askcss.com.au/",                      category:"Non-Profit",  accent:"#10b981", pattern:"cross", size:"normal", desc:"Community support services platform connecting clients with disability and welfare support." },
  { id:5,  title:"Equifund",                    url:"https://equifund.com.au/",                        category:"Finance",     accent:"#3b82f6", pattern:"grid",  size:"normal", desc:"Australian equity funding platform with investor portal and deal flow management." },
  { id:6,  title:"Maricc",                      url:"https://maricc.com/",                             category:"Web Design",  accent:"#ec4899", pattern:"dots",  size:"normal", desc:"Modern corporate website with premium branding, animations and lead generation focus." },
  { id:7,  title:"De La Mar Academy",           url:"https://delamaracademy.co.uk/",                   category:"Education",   accent:"#8b5cf6", pattern:"lines", size:"large",  desc:"UK performing arts academy site with course enrolment, events calendar and media showcase." },
  { id:8,  title:"SB Event Horizon",            url:"https://sbeventhorizon.com/",                     category:"Hospitality", accent:"#f97316", pattern:"cross", size:"normal", desc:"Event management and venue platform with booking system and immersive visual design." },
  { id:9,  title:"Halstein",                    url:"https://halstein.qodeinteractive.com/",           category:"Web Design",  accent:"#d4af37", pattern:"grid",  size:"normal", desc:"Premium lifestyle brand digital experience with editorial design and ecommerce integration." },
  { id:10, title:"HRM Tech",                    url:"http://www.hrmtech.co.uk/",                       category:"Technology",  accent:"#0ea5e9", pattern:"dots",  size:"normal", desc:"UK HR technology company website showcasing workforce solutions and SaaS platform." },
  { id:11, title:"FS Partners NC",              url:"https://fspartnersnc.com/",                       category:"Finance",     accent:"#34d399", pattern:"lines", size:"normal", desc:"Financial services partnership firm with client portal and professional brand identity." },
  { id:12, title:"Alpha1 Research",             url:"https://alpha1research.com/",                     category:"Technology",  accent:"#a78bfa", pattern:"cross", size:"large",  desc:"Research and analytics platform with data visualisation and subscription-based access." },
  { id:13, title:"AEPP LLC",                    url:"https://www.aeppllc.com/",                        category:"Industry",    accent:"#fb923c", pattern:"grid",  size:"normal", desc:"Professional services company with clean corporate identity and service portfolio." },
  { id:14, title:"Infotech Group",              url:"https://infotechgroup.com/",                      category:"Technology",  accent:"#3b82f6", pattern:"dots",  size:"normal", desc:"IT solutions group website with service architecture, case studies and conversion focus." },
  { id:15, title:"Joanne Horowitz",             url:"https://joannehorowitz.online/",                  category:"Healthcare",  accent:"#f472b6", pattern:"lines", size:"normal", desc:"Personal coaching and wellness practice site with booking, blog and brand storytelling." },
  { id:16, title:"Vita Consulting",             url:"https://www.vitaconsulting.co.uk/",               category:"Finance",     accent:"#d4af37", pattern:"cross", size:"normal", desc:"UK business consulting firm with thought leadership content and client engagement tools." },
  { id:17, title:"Digital Kiwi Tech",           url:"https://digitalkiwitech.co.nz/",                  category:"Technology",  accent:"#10b981", pattern:"grid",  size:"normal", desc:"New Zealand digital technology agency showcasing web, app and cloud services." },
  { id:18, title:"Solo Rack",                   url:"https://solo-rack.com/",                          category:"Ecommerce",   accent:"#f59e0b", pattern:"dots",  size:"large",  desc:"Premium ecommerce store with product showcase, inventory management and checkout optimisation." },
  { id:19, title:"Daniel Pays",                 url:"https://danielpays.com/",                         category:"Finance",     accent:"#6366f1", pattern:"lines", size:"normal", desc:"Fintech payments platform with modern UI, onboarding flows and trust-building design." },
  { id:20, title:"KDFSB",                       url:"https://kdfsb.org/",                              category:"Non-Profit",  accent:"#0ea5e9", pattern:"cross", size:"normal", desc:"Faith-based community organisation with events management, giving portal and outreach tools." },
  { id:21, title:"CMM Renovations",             url:"https://cmmrenovations.com.au/",                  category:"Industry",    accent:"#fb923c", pattern:"grid",  size:"normal", desc:"Australian residential renovation company with project gallery and quote request system." },
  { id:22, title:"Tier 1 Business Group",       url:"https://tier1businessgroup.com/",                 category:"Finance",     accent:"#d4af37", pattern:"dots",  size:"normal", desc:"Business advisory group with premium brand positioning, service showcase and lead capture." },
  { id:23, title:"Elite Tooling Services",      url:"https://elitetoolingservices.com/",               category:"Industry",    accent:"#9ca3af", pattern:"lines", size:"normal", desc:"Industrial tooling and manufacturing services company with product catalogue and RFQ." },
  { id:24, title:"Abilities RC",               url:"https://abilitiesrc.com/",                        category:"Healthcare",  accent:"#34d399", pattern:"cross", size:"large",  desc:"Disability resource centre with NDIS service listings, participant portal and referral tools." },
  { id:25, title:"Overland Speech Therapy",     url:"https://www.overlandspeechtherapy.com.au/",       category:"Healthcare",  accent:"#a78bfa", pattern:"grid",  size:"normal", desc:"Speech pathology practice with online booking, resource library and telehealth access." },
  { id:26, title:"RPM Engineering",             url:"https://www.rpmengineering.com.au/",               category:"Industry",    accent:"#f59e0b", pattern:"dots",  size:"normal", desc:"Australian engineering consultancy with project showcase, capability statements and enquiry forms." },
  { id:27, title:"Caladonna",                   url:"https://caladonna.com.au/",                       category:"Ecommerce",   accent:"#ec4899", pattern:"lines", size:"normal", desc:"Premium Australian brand with immersive ecommerce experience and lifestyle editorial content." },
  { id:28, title:"My Daily Support Service",    url:"https://mydailysupportservice.com/",              category:"Healthcare",  accent:"#10b981", pattern:"cross", size:"normal", desc:"NDIS support services provider with participant intake, service catalogue and team showcase." },
  { id:29, title:"Asset Training Enrol",        url:"https://assettrainingenrol.com.au/",              category:"Education",   accent:"#3b82f6", pattern:"grid",  size:"large",  desc:"Australian RTO training enrolment platform with course listings, intake forms and compliance." },
  { id:30, title:"Riot Kyabram",               url:"https://riotkyabram.com/",                        category:"Hospitality", accent:"#f97316", pattern:"dots",  size:"normal", desc:"Entertainment venue website with event listings, ticketing, gallery and social integration." },
  { id:31, title:"Key 2 Driving",              url:"https://key2driving.com/",                        category:"Education",   accent:"#fbbf24", pattern:"lines", size:"normal", desc:"Driving school platform with lesson booking, instructor profiles and student progress tracking." },
  { id:32, title:"JR Book Accounting",          url:"https://jrbookaccounting.com/",                   category:"Finance",     accent:"#d4af37", pattern:"cross", size:"normal", desc:"Boutique accounting practice website with service packages, tax tips blog and client portal." },
  { id:33, title:"Booxkeeping",                 url:"https://www.booxkeeping.com/",                    category:"Finance",     accent:"#34d399", pattern:"grid",  size:"normal", desc:"Modern bookkeeping SaaS with clean UI, pricing tiers, and automated client onboarding." },
];
